...
if (isset($_POST['submit'])) {
    ...
    foreach ($log as $item) {
        ...
        if ($username == $item['user_id'] && md5($password) == $item['password']) {
            ...
            header('Location:/RMSupdate/Faculty/dashboard/dashboard.php');
        } else {
            $flag = 1;
        }
    }
...
<body>
    ...
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <div class="mainContainer">
            ...
            <!-- Sign up link -->
            <p class="register">Not a member? <a href="../Faculty/SignUp.php">create account!</a></p>
            <button type="submit" name="submit" value="submit">Login as Faculty</button>
        </div>
    ...
    <a href="..\..\Faculty\dashboard\dashboard.php">
