    ...
    <!--Form end-->
      ...
      <div class="result-div">
        <div class="marksdiv mb-5">
          <button type="button" class="btn btn-secondary btn-lg btn-block"><a href="http://eeee.com" style="color: #fff;">Attendance Marks</a></button>
          <table class="table text-dark">
            ...
            <tbody>
              ...
              <tr>
                <td>04</td>
                <td>BASICS OF CIVIL & MECHANICAL ENGINEERING</td>
                <td>CST106</td>
                <td>78</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>06</td>
                <td> BASICS OF ELECTRICAL & ELECTRONICS ENGINEERING</td>
                <td>CST109</td>
                <td>58</td>
              </tr>
            </tbody>
